...
# SAFETY WARNING:
# This calculator assumes non-thermal signal intensities (< 1mW).
# Do not scale parameters for high-power transmission.
# Excessive RF exposure at 1.42 GHz may cause tissue heating.
